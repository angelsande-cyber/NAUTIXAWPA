...
const Num0 = () => (
    <svg viewBox="-0.5 -0.5 21 13" fill="none">
        ...
        <path d="M0 0 H20 L15 12 H0 Z" stroke="#4A4A4A" strokeWidth="0.5" fill="none" />
    </svg>
);
const Num1 = () => <svg viewBox="-0.5 -0.5 21 13" fill="none"><path d="M0 0 H20 L15 12 H0 Z" fill="#fff" stroke="#4A4A4A" strokeWidth="0.5" /><circle cx="8" cy="6" r="2.5" fill="#d72828"/></svg>;
const Num2 = () => <svg viewBox="-0.5 -0.5 21 13" fill="none"><path d="M0 0 H20 L15 12 H0 Z" fill="#0058a7" stroke="#4A4A4A" strokeWidth="0.5"/><circle cx="8" cy="6" r="2.5" fill="#fff"/></svg>;
const Num3 = () => (
    <svg viewBox="-0.5 -0.5 21 13" fill="none">
        <defs>
...
const Num4 = () => (
    <svg viewBox="-0.5 -0.5 21 13" fill="none">
        ...
        <g clipPath="url(#clipPennant4)">
            <path d="M0 0 H20 V12 H0 Z" fill="#d72828" />
...
const Num8 = () => (
    <svg viewBox="-0.5 -0.5 21 13" fill="none">
        ...
        <g clipPath="url(#clipPennant8)">
            <path d="M0 0 H20 V12 H0 Z" fill="#fff" />
