...
const FlagG = () => <svg viewBox="0 0 15 12"><path d="M0,0 H2.5 V12 H0Z M5,0 H7.5 V12 H5Z M10,0 H12.5 V12 H10Z" fill="#ffcd00" stroke="#0058a7" stroke-width="2.5" /><path d="M2.5,0 H5 V12 H2.5Z M7.5,0 H10 V12 H7.5Z M12.5,0 H15 V12 H12.5Z" fill="#0058a7" /></svg>;
...
const FlagM = () => <svg viewBox="0 0 15 12"><path d="M0 0 H15 V12 H0Z" fill="#0058a7"/><path d="M1.5 1.5 L13.5 10.5 M1.5 10.5 L13.5 1.5" stroke="#fff" strokeWidth="2.5"/></svg>;
const FlagN = () => <svg viewBox="0 0 15 12"><rect width="15" height="12" fill="#0058a7"/><path d="M0,0 h3v3h-3z m3,3 h3v3h-3z m-3,3 h3v3h-3z m3,3 h3v3h-3z m3,-12 h3v3h-3z m3,3 h3v3h-3z m-3,3 h3v3h-3z m3,3 h3v3h-3z m3,-12 h3v3h-3z m3,3 h3v3h-3z m-3,3 h3v3h-3z m3,3 h3v3h-3z" fill="#fff" transform="translate(1.5,0) scale(1,1)"/></svg>;
const FlagO = () => <svg viewBox="0 0 15 12"><path d="M0 0 H15 V12 H0Z" fill="#ffcd00"/><path d="M0 0 L15 0 L0 12Z" fill="#d72828"/></svg>;
...
const FlagV = () => <svg viewBox="0 0 15 12"><path d="M0 0 H15 V12 H0Z" fill="#fff"/><path d="M1.5 1.5 L13.5 10.5 M1.5 10.5 L13.5 1.5" stroke="#d72828" strokeWidth="2.5"/></svg>;
...
const FlagY = () => <svg viewBox="0 0 15 12"><path d="M0 0 L7.5 6 L0 12 Z M0 0 L7.5 0 L7.5 6 Z" fill="#ffcd00" /><path d="M7.5 0 L15 0 L7.5 6 Z M15 0 L15 6 L7.5 6 Z" fill="#d72828" /><path d="M0 12 L7.5 6 L0 6 Z M0 12 L7.5 12 L7.5 6 Z" fill="#d72828" /><path d="M7.5 12 L15 12 L15 6 L7.5 6 Z" fill="#ffcd00" /></svg>;
const FlagZ = () => <svg viewBox="0 0 15 12"><path d="M0 0 L15 0 L0 12Z" fill="#0058a7"/><path d="M15 0 L0 12 L15 12Z" fill="#ffcd00" /><path d="M0 0 L15 0 L7.5 6Z" fill="#000" /><path d="M0 12 L15 12 L7.5 6Z" fill="#d72828" /></svg>;
...
const Num3 = () => <svg viewBox="0 0 20 12"><path d={pennantShape} fill="#fff"/><path d="M0 0 H6.6 V12 H0Z" fill="#d72828"/><path d="M6.6 0 H13.2 V12 H6.6Z" fill="#0058a7"/></svg>;
...
const Num0 = () => <svg viewBox="0 0 20 12"><path d={pennantShape} fill="#ffcd00"/><path d="M0 0 H6.6 V12 H0Z" fill="#d72828"/><path d="M6.6 0 H13.2 V12 H6.6Z" fill="#d72828"/></svg>;
