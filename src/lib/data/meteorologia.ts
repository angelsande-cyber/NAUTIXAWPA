...
export const METEO_DATA = {
    ...
    cloudTypeKeys: [
        { type: 'meteo.clouds.types.cirrus.name', altitude: 'meteo.clouds.types.cirrus.altitude', description: 'meteo.clouds.types.cirrus.description', imageUrl: 'https://upload.wikimedia.org/wikipedia/commons/thumb/7/73/Cirrus_clouds2.jpg/1280px-Cirrus_clouds2.jpg', hint: 'cirrus wispy' },
        { type: 'meteo.clouds.types.cirrocumulus.name', altitude: 'meteo.clouds.types.cirrocumulus.altitude', description: 'meteo.clouds.types.cirrocumulus.description', imageUrl: 'https://upload.wikimedia.org/wikipedia/commons/thumb/3/36/Cirrocumulus_stratiformis_undulatus.jpg/1280px-Cirrocumulus_stratiformis_undulatus.jpg', hint: 'cirrocumulus mackerel' },
        { type: 'meteo.clouds.types.cirrostratus.name', altitude: 'meteo.clouds.types.cirrostratus.altitude', description: 'meteo.clouds.types.cirrostratus.description', imageUrl: 'https://upload.wikimedia.org/wikipedia/commons/thumb/0/07/Halo_over_the_sea.jpg/1280px-Halo_over_the_sea.jpg', hint: 'cirrostratus halo' },
        { type: 'meteo.clouds.types.altocumulus.name', altitude: 'meteo.clouds.types.altocumulus.altitude', description: 'meteo.clouds.types.altocumulus.description', imageUrl: 'https://upload.wikimedia.org/wikipedia/commons/thumb/f/f0/Altocumulus_stratiformis_perlucidus.jpg/1280px-Altocumulus_stratiformis_perlucidus.jpg', hint: 'altocumulus midlevel' },
        { type: 'meteo.clouds.types.altostratus.name', altitude: 'meteo.clouds.types.altostratus.altitude', description: 'meteo.clouds.types.altostratus.description', imageUrl: 'https://upload.wikimedia.org/wikipedia/commons/thumb/e/e3/Altostratus_translucidus_below_cirrostratus_fibratus.jpg/1280px-Altostratus_translucidus_below_cirrostratus_fibratus.jpg', hint: 'altostratus sheet' },
        { type: 'meteo.clouds.types.nimbostratus.name', altitude: 'meteo.clouds.types.nimbostratus.altitude', description: 'meteo.clouds.types.nimbostratus.description', imageUrl: 'https://upload.wikimedia.org/wikipedia/commons/thumb/b/b3/Nimbostratus_by_Cezary_P._1.jpg/1280px-Nimbostratus_by_Cezary_P._1.jpg', hint: 'nimbostratus rain' },
        { type: 'meteo.clouds.types.stratus.name', altitude: 'meteo.clouds.types.stratus.altitude', description: 'meteo.clouds.types.stratus.description', imageUrl: 'https://upload.wikimedia.org/wikipedia/commons/thumb/a/a3/Stratus_fractus_clouds.jpg/1280px-Stratus_fractus_clouds.jpg', hint: 'stratus layer' },
        { type: 'meteo.clouds.types.stratocumulus.name', altitude: 'meteo.clouds.types.stratocumulus.altitude', description: 'meteo.clouds.types.stratocumulus.description', imageUrl: 'https://upload.wikimedia.org/wikipedia/commons/thumb/c/ce/Stratocumulus_perlucidus.jpg/1280px-Stratocumulus_perlucidus.jpg', hint: 'stratocumulus low' },
        { type: 'meteo.clouds.types.cumulus.name', altitude: 'meteo.clouds.types.cumulus.altitude', description: 'meteo.clouds.types.cumulus.description', imageUrl: 'https://upload.wikimedia.org/wikipedia/commons/thumb/3/35/Cumulus_humilis_clouds.jpg/1280px-Cumulus_humilis_clouds.jpg', hint: 'cumulus fluffy' },
        { type: 'meteo.clouds.types.cumulonimbus.name', altitude: 'meteo.clouds.types.cumulonimbus.altitude', description: 'meteo.clouds.types.cumulonimbus.description', imageUrl: 'https://upload.wikimedia.org/wikipedia/commons/thumb/b/b5/Cumulonimbus_Cloud_over_Pork_kala_-_K%C3%A4smu_Bay.jpg/1280px-Cumulonimbus_Cloud_over_Pork_kala_-_K%C3%A4smu_Bay.jpg', hint: 'cumulonimbus storm' }
    ]
};
