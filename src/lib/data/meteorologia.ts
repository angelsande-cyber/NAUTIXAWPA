...
export const douglasSeaScaleKeys = [
...
export const douglasSwellScaleKeys = [
...
export const METEO_DATA = {
    ...
    cloudTypeKeys: [
        { type: 'meteo.clouds.types.cirrus.name', altitude: 'meteo.clouds.types.cirrus.altitude', description: 'meteo.clouds.types.cirrus.description', imageUrl: '/images/clouds/cirrus.jpg', hint: 'meteo.clouds.types.cirrus.hint' },
        { type: 'meteo.clouds.types.cirrocumulus.name', altitude: 'meteo.clouds.types.cirrocumulus.altitude', description: 'meteo.clouds.types.cirrocumulus.description', imageUrl: '/images/clouds/cirrocumulus.jpg', hint: 'meteo.clouds.types.cirrocumulus.hint' },
        { type: 'meteo.clouds.types.cirrostratus.name', altitude: 'meteo.clouds.types.cirrostratus.altitude', description: 'meteo.clouds.types.cirrostratus.description', imageUrl: '/images/clouds/cirrostratus.jpg', hint: 'meteo.clouds.types.cirrostratus.hint' },
        { type: 'meteo.clouds.types.altocumulus.name', altitude: 'meteo.clouds.types.altocumulus.altitude', description: 'meteo.clouds.types.altocumulus.description', imageUrl: '/images/clouds/altocumulus.jpg', hint: 'meteo.clouds.types.altocumulus.hint' },
        { type: 'meteo.clouds.types.altostratus.name', altitude: 'meteo.clouds.types.altostratus.altitude', description: 'meteo.clouds.types.altostratus.description', imageUrl: '/images/clouds/altostratus.jpg', hint: 'meteo.clouds.types.altostratus.hint' },
        { type: 'meteo.clouds.types.nimbostratus.name', altitude: 'meteo.clouds.types.nimbostratus.altitude', description: 'meteo.clouds.types.nimbostratus.description', imageUrl: '/images/clouds/nimbostratus.jpg', hint: 'meteo.clouds.types.nimbostratus.hint' },
        { type: 'meteo.clouds.types.stratus.name', altitude: 'meteo.clouds.types.stratus.altitude', description: 'meteo.clouds.types.stratus.description', imageUrl: '/images/clouds/stratus.jpg', hint: 'meteo.clouds.types.stratus.hint' },
        { type: 'meteo.clouds.types.stratocumulus.name', altitude: 'meteo.clouds.types.stratocumulus.altitude', description: 'meteo.clouds.types.stratocumulus.description', imageUrl: '/images/clouds/stratocumulus.jpg', hint: 'meteo.clouds.types.stratocumulus.hint' },
        { type: 'meteo.clouds.types.cumulus.name', altitude: 'meteo.clouds.types.cumulus.altitude', description: 'meteo.clouds.types.cumulus.description', imageUrl: '/images/clouds/cumulus.jpg', hint: 'meteo.clouds.types.cumulus.hint' },
        { type: 'meteo.clouds.types.cumulonimbus.name', altitude: 'meteo.clouds.types.cumulonimbus.altitude', description: 'meteo.clouds.types.cumulonimbus.description', imageUrl: '/images/clouds/cumulonimbus.jpg', hint: 'meteo.clouds.types.cumulonimbus.hint' }
    ]
};
