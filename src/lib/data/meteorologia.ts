...
export const METEO_DATA = {
    ...
    cloudTypeKeys: [
        ...
        { type: 'meteo.clouds.types.cirrocumulus.name', altitude: 'meteo.clouds.types.cirrocumulus.altitude', description: 'meteo.clouds.types.cirrocumulus.description', imageUrl: 'https://images.pexels.com/photos/5359966/pexels-photo-5359966.jpeg?auto=compress&cs=tinysrgb&w=400&h=300&dpr=1', hint: 'cirrocumulus mackerel' },
        { type: 'meteo.clouds.types.cirrostratus.name', altitude: 'meteo.clouds.types.cirrostratus.altitude', description: 'meteo.clouds.types.cirrostratus.description', imageUrl: 'https://images.pexels.com/photos/4067980/pexels-photo-4067980.jpeg?auto=compress&cs=tinysrgb&w=400&h=300&dpr=1', hint: 'cirrostratus halo' },
        { type: 'meteo.clouds.types.altocumulus.name', altitude: 'meteo.clouds.types.altocumulus.altitude', description: 'meteo.clouds.types.altocumulus.description', imageUrl: 'https://images.pexels.com/photos/1531660/pexels-photo-1531660.jpeg?auto=compress&cs=tinysrgb&w=400&h=300&dpr=1', hint: 'altocumulus midlevel' },
        { type: 'meteo.clouds.types.altostratus.name', altitude: 'meteo.clouds.types.altostratus.altitude', description: 'meteo.clouds.types.altostratus.description', imageUrl: 'https://images.pexels.com/photos/531756/pexels-photo-531756.jpeg?auto=compress&cs=tinysrgb&w=400&h=300&dpr=1', hint: 'altostratus sheet' },
        { type: 'meteo.clouds.types.nimbostratus.name', altitude: 'meteo.clouds.types.nimbostratus.altitude', description: 'meteo.clouds.types.nimbostratus.description', imageUrl: 'https://images.pexels.com/photos/2097628/pexels-photo-2097628.jpeg?auto=compress&cs=tinysrgb&w=400&h=300&dpr=1', hint: 'nimbostratus rain' },
        { type: 'meteo.clouds.types.stratus.name', altitude: 'meteo.clouds.types.stratus.altitude', description: 'meteo.clouds.types.stratus.description', imageUrl: 'https://images.pexels.com/photos/414144/pexels-photo-414144.jpeg?auto=compress&cs=tinysrgb&w=400&h=300&dpr=1', hint: 'stratus layer' },
        { type: 'meteo.clouds.types.stratocumulus.name', altitude: 'meteo.clouds.types.stratocumulus.altitude', description: 'meteo.clouds.types.stratocumulus.description', imageUrl: 'https://images.pexels.com/photos/1485805/pexels-photo-1485805.jpeg?auto=compress&cs=tinysrgb&w=400&h=300&dpr=1', hint: 'stratocumulus low' },
        { type: 'meteo.clouds.types.cumulus.name', altitude: 'meteo.clouds.types.cumulus.altitude', description: 'meteo.clouds.types.cumulus.description', imageUrl: 'https://images.pexels.com/photos/534285/pexels-photo-534285.jpeg?auto=compress&cs=tinysrgb&w=400&h=300&dpr=1', hint: 'cumulus fluffy' },
        { type: 'meteo.clouds.types.cumulonimbus.name', altitude: 'meteo.clouds.types.cumulonimbus.altitude', description: 'meteo.clouds.types.cumulonimbus.description', imageUrl: 'https://images.pexels.com/photos/33545/sunrise-phu-quoc-island-ocean.jpg?auto=compress&cs=tinysrgb&w=400&h=300&dpr=1', hint: 'cumulonimbus storm' }
    ]
};
