...
export const METEO_DATA = {
    ...
    cloudTypeKeys: [
        { type: 'meteo.clouds.types.cirrus.name', altitude: 'meteo.clouds.types.cirrus.altitude', description: 'meteo.clouds.types.cirrus.description', imageUrl: 'https://picsum.photos/id/10/400/300', hint: 'cirrus wispy' },
        { type: 'meteo.clouds.types.cirrocumulus.name', altitude: 'meteo.clouds.types.cirrocumulus.altitude', description: 'meteo.clouds.types.cirrocumulus.description', imageUrl: 'https://picsum.photos/id/11/400/300', hint: 'cirrocumulus mackerel' },
        { type: 'meteo.clouds.types.cirrostratus.name', altitude: 'meteo.clouds.types.cirrostratus.altitude', description: 'meteo.clouds.types.cirrostratus.description', imageUrl: 'https://picsum.photos/id/12/400/300', hint: 'cirrostratus halo' },
        { type: 'meteo.clouds.types.altocumulus.name', altitude: 'meteo.clouds.types.altocumulus.altitude', description: 'meteo.clouds.types.altocumulus.description', imageUrl: 'https://picsum.photos/id/13/400/300', hint: 'altocumulus midlevel' },
        { type: 'meteo.clouds.types.altostratus.name', altitude: 'meteo.clouds.types.altostratus.altitude', description: 'meteo.clouds.types.altostratus.description', imageUrl: 'https://picsum.photos/id/14/400/300', hint: 'altostratus sheet' },
        { type: 'meteo.clouds.types.nimbostratus.name', altitude: 'meteo.clouds.types.nimbostratus.altitude', description: 'meteo.clouds.types.nimbostratus.description', imageUrl: 'https://picsum.photos/id/15/400/300', hint: 'nimbostratus rain' },
        { type: 'meteo.clouds.types.stratus.name', altitude: 'meteo.clouds.types.stratus.altitude', description: 'meteo.clouds.types.stratus.description', imageUrl: 'https://picsum.photos/id/16/400/300', hint: 'stratus layer' },
        { type: 'meteo.clouds.types.stratocumulus.name', altitude: 'meteo.clouds.types.stratocumulus.altitude', description: 'meteo.clouds.types.stratocumulus.description', imageUrl: 'https://picsum.photos/id/17/400/300', hint: 'stratocumulus low' },
        { type: 'meteo.clouds.types.cumulus.name', altitude: 'meteo.clouds.types.cumulus.altitude', description: 'meteo.clouds.types.cumulus.description', imageUrl: 'https://picsum.photos/id/18/400/300', hint: 'cumulus fluffy' },
        { type: 'meteo.clouds.types.cumulonimbus.name', altitude: 'meteo.clouds.types.cumulonimbus.altitude', description: 'meteo.clouds.types.cumulonimbus.description', imageUrl: 'https://picsum.photos/id/19/400/300', hint: 'cumulonimbus storm' }
    ]
};
