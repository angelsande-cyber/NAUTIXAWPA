...
export const sailSameTackScenario: ManeuverScenario = {
    ...
    explanation: "El velero a barlovento (B, Rojo), que está más cerca del viento (izquierda), debe maniobrar con antelación para pasar por la popa del velero a sotavento (A, Verde), que tiene derecho de paso y mantiene su rumbo.",
    windDirection: 'W'
};
